...
void Map::SetViewingMapPoints(const vector<MapPoint *> &vpMPs)
{
    unique_lock<mutex> lock(mMutexMap);
    mvpVeiwingMapPoints = vpMPs;
}
...
vector<MapPoint*> Map::GetViewingMapPoints()
{
    unique_lock<mutex> lock(mMutexMap);
    return mvpVeiwingMapPoints;
}


vector<MapPoint*> Map::GetCulledMapPoints()
{
    unique_lock<mutex> lock(mMutexMap);
    return culledMapPoints;
}

void Map::addCulledMapPoints(MapPoint *pMP)
{
    unique_lock<mutex> lock(mMutexMap);
    culledMapPoints.push_back(pMP);
}
////////////
...
void Map::serialize(Archive &ar, const unsigned int version)
{
    ...
    ar &mspMapPoints;
    cout << "mspMapPoints : " << mspMapPoints.size() << endl;
    ar &mvpKeyFrameOrigins;
    ar &mspKeyFrames;
    cout << "mspKeyFrames : " << mspKeyFrames.size() << endl;
    ar &mvpReferenceMapPoints;
    cout << "mvpReferenceMapPoints : " << mvpReferenceMapPoints.size() << endl;
