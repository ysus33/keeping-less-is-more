...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuLocalizationMode("menu.Change Mode",mbReuseMap,false);
    pangolin::Var<bool> menuFollowCamera("menu.Follow Camera",true,true);
    pangolin::Var<bool> menuShowCulledPoints("menu.Culled Points",true,true);
    ...
    while(1)
    {
        ...
        mpMapDrawer->DrawMapPoints(bLocalizationMode);
        if(menuShowCulledPoints)
            mpMapDrawer->DrawCulledMapPoints();
